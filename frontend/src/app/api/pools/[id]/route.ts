...
const mockPools: Record<number, Pool> = {
  1: {
    ...
    description:
      "Flow EVM Testnet Pool - Help fund development of decentralized applications on Flow EVM",
  ...
  2: {
    ...
    description:
      "Community Garden Project - Creating a sustainable community garden for local food production",
  ...
  3: {
    ...
    description:
      "Open Source Library Development - Building tools for the Web3 developer community",
...
export async function GET(
  ...
  try {
    ...
    const poolId = parseInt(resolvedParams.id);
